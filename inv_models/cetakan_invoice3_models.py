...
class CNWCetakanInvoice3(models.TransientModel):
    _name           = "cnw.cetakan.invoice3"
    _description    = "Cetakan Invoice3"
...
#MULTI COMPANY 
        ...
        msgsql =  """exec [dbo].[IGU_ACT_INVOICE_HEADER_BILLTO]  '""" + self.inv_from +  """','""" + self.inv_to +  """','""" + self.datefrom.strftime("%Y%m%d")  +  """','""" + self.dateto.strftime("%Y%m%d") +  """' """
        msgsql2 =  """exec [dbo].[IGU_ACT_INVOICE_DETAIL_BILLTO]  '""" + self.inv_from +  """','""" + self.inv_to +  """','""" + self.datefrom.strftime("%Y%m%d")  +  """','""" + self.dateto.strftime("%Y%m%d") +  """' """
