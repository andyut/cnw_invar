...
class AWR_InterCompSewa(models.TransientModel):
    _name           = "cnw.intercomp.sewa"
    _description    = "cnw.intercomp.sewa"
    ...
    def view_intercomp(self): 
        ...
        filename    = 'INTERCOMP_SEWA'+ self.env.user.company_id.db_name +  self.dateto.strftime("%Y%m%d")  + '.xlsx'
        filenamexls    = 'INTERCOMP_SEWA'+ self.env.user.company_id.db_name +   self.dateto.strftime("%Y%m%d")  + '.xlsx'
        filenamexls2    = 'INTERCOMP_SEWA'+  self.env.user.company_id.db_name +  self.dateto.strftime("%Y%m%d")  + '.xlsx'
        filenamepdf = 'INTERCOMP_SEWA'+  self.env.user.company_id.db_name +  self.dateto.strftime("%Y%m%d")  + '.pdf'
